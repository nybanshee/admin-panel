...
import { ChevronRight, Crosshair, Move3d, Activity, Target, Component, Layers, PenTool, Map, Swords } from 'lucide-react';
            ...
            {expandedGun === gun.id && (
                ...
                >
                    <div className="relative ml-6 pl-6 py-4 border-l border-slate-700 space-y-2">
                        ...
                        {/* Magazine Sequence Editor */}
                        <div className="mb-6 p-4 bg-slate-900/30 border border-slate-800 rounded-lg">
                        ...
                        <div className="space-y-3">
                            ...
                            {recoilPatterns.map(p=> (
                                <div key={p.id} className="flex items-center justify-between border border-slate-800 bg-slate-900/40 p-3">
                                    ...
                                    <div className="flex gap-2">
                                        <button className="px-3 py-2 text-xs bg-slate-800 border border-slate-700 text-cyan-400" onClick={()=>{
                                            // assign globally? selection happens in gun editor via select
                                        }}>Use</button>
